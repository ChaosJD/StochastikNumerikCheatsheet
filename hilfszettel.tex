...
\input{inhalt/BeschreibendeStatistik}
\input{inhalt/Wahrscheinlichkeitsrechnung}
\input{inhalt/Zufallsvariablen}
\input{inhalt/SpezielleVerteilungen}
\input{inhalt/ZentralerGrenzwertsatz}
\input{inhalt/Konfidenzintervall}
\input{inhalt/Hypothesentest}
\input{inhalt/Fehleranalyse}
\input{inhalt/Interpolation}
\input{inhalt/Allg}
